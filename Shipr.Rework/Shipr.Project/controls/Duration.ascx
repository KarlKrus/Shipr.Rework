...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6">
                <asp:Label ID="lblStartDate" runat="server" CssClass="control-label">Start date: </asp:Label>*
                <asp:TextBox ID="txtStartDate" runat="server" onfocus="this.value=='MM/DD/YYYY'?this.value='':null" Width="100px" MaxLength="10" CssClass="form-control" TextMode="Date">MM/DD/YYYY</asp:TextBox>
            ...
            <div class="col-sm-6">
                <asp:Label ID="lblEndDate" runat="server" CssClass="control-label">End date: </asp:Label>*
            </div>
        </div>
    </div>
</div>
