...
namespace ShipR.Data
{
    public class PromoData
    {
        ...
        public static void SavePromo(Promo promo, Boolean isUpdate)
        {
        ...
        private static Promo SavePromoExceptions(Promo promo)
        ...
        private static void UpdateRules(Promo promo)
        {
            Database db = DatabaseFactory.CreateDatabase("RAP");
